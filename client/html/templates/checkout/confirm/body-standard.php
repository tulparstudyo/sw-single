...
?>
<section class="aimeos container checkout-confirm" data-jsonurl="<?= $enc->attr( $this->url( $optTarget, $optCntl, $optAction, [], [], $optConfig ) ); ?>">
	...
	<h2><?= $enc->html( $this->translate( 'client', 'Confirmation' ), $enc::TRUST ); ?></h2>
	</div>
