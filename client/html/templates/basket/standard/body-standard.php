...
?>
<section class="aimeos container  basket-standard" data-jsonurl="<?= $enc->attr( $this->url( $optTarget, $optCntl, $optAction, [], [], $optConfig ) ); ?>">
	...
	<?php if( isset( $this->standardBasket ) ) : ?>
		...
		<form method="POST" action="<?= $enc->attr( $this->url( $basketTarget, $basketController, $basketAction, [], [], $basketConfig ) ); ?>">
			...
			<div class="common-summary-detail">
				<div class="header">
				<h6><?= $enc->html( $this->translate( 'client', 'Basket' ), $enc::TRUST ); ?>-<?= $enc->html( $this->translate( 'client', 'Details' ), $enc::TRUST ); ?></h6>
