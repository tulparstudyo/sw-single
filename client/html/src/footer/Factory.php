...
namespace Aimeos\Client\Html\Swordbros\Techie\Footer;
	...
	implements \Aimeos\Client\Html\Common\Factory\Iface
{
	...
	{
    if( $name === null ) {
			$name = $context->getConfig()->get( 'client/html/footer', 'Standard' );
		}

		$iface = '\\Aimeos\\Client\\Html\\Iface';
		$classname = '\\Aimeos\\Client\\Html\\Swordbros\\Techie\\Footer\\' . $name;
		...
		$client = self::addClientDecorators( $context, $client, 'techie/footer' );
